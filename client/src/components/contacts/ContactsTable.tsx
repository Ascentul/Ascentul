                  ...
                  {contact.lastContactedDate ? (
                    <>
                      ...
                      {needsFollowUp(contact.lastContactedDate) && (
                        <Badge variant="outline" className="mt-1 bg-red-100 text-red-800 border-transparent px-2.5 py-0.5 text-sm inline-flex items-center justify-center rounded-full font-medium">
                          Needs follow-up
                        </Badge>
                      )}
                    </>
                  ) : (
                    <Badge variant="outline" className="bg-gray-100 text-gray-800 border-transparent px-2.5 py-0.5 text-sm inline-flex items-center justify-center rounded-full font-medium">
                      Never contacted
                    </Badge>
                  )}
                </div>
