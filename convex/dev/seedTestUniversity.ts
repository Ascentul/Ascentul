...
export const seed = mutation({
  ...
  handler: async (ctx) => {
    ...
    const testUniversity = {
      ...
      logo_url: "https://ui-avatars.com/api/?name=AU&background=5371FF&color=fff&size=128&bold=true",
    ...
    const testUserEmails: Array<{ email: string; expectedRole: "student" | "advisor" | "university_admin" }> = [
