...
import { logOpenAIUsage } from "../utils/openai-logger";
 ...
 */
export async function createChatCompletionWithLogs({ messages, model = DEFAULT_MODEL, temperature = 0.7, userId = "anonymous", max_tokens, responseFormat }) {
