 ...
 */
export function registerOpenAILogsRoutes(router) {
    ...
    router.get('/admin/openai-logs', requireAdmin, (req, res) => {
        try {
    ...
    router.get('/admin/openai-stats/models', requireAdmin, (req, res) => {
        try {
    ...
    router.get('/admin/openai-stats/users', requireAdmin, (req, res) => {
        try {
    ...
    // Export logs as CSV
    router.get('/admin/openai-logs/export', requireAdmin, (req, res) => {
        try {
