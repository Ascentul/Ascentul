...
export default function CoverLetter() {
  ...
  const filteredLetters = () => {
    ...
    if (searchQuery) {
      ...
      return coverLetters.filter((letter: any) =>
    ...
    >
                      ...
                      <div className="bg-primary/5 p-6 flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-neutral-500">
                            {letter.template.charAt(0).toUpperCase() +
                              letter.template.slice(1)}{" "}
                            Template
                          </p>
                    ...
                    <CardFooter className="p-4 flex justify-between">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button
                          ...
                          className="h-8 w-8"
                          onClick={() =>
                            duplicateCoverLetterMutation.mutate(letter)
                          }
                        >
                          ...
                          onClick={() => {
                            ...
                            hiddenDiv.innerHTML = `
                              <div class="bg-white p-6">
                                ...
                                <div class="mb-6">
                                  <p>${
                                    letter.content.recipient.company || ""
                                  }</p>
                                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="space-y-5">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                  Get AI-powered feedback on your cover letter and suggestions
                  to improve it for a specific job opportunity.
                </p>
                ...
                {!analysisResult ? (
                  <div className="flex flex-col items-center justify-center h-[400px] py-12 text-center bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-sm max-w-md">
                      Submit your cover letter and job description to see
                      AI-powered analysis and suggestions.
                    </p>
                    <p className="text-gray-400 dark:text-gray-500 text-xs mt-3 max-w-xs">
                      Our AI will analyze your cover letter for job fit,
                  ...
                  {generatedContent ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-full py-12 text-center">
                      ...
                      <p className="text-gray-500 dark:text-gray-400 text-sm">
                        Fill out the form and generate a professional cover
                        letter
                      </p>
                      <p className="text-gray-400 dark:text-gray-500 text-xs mt-2 max-w-md">
                        Our AI will craft a personalized cover letter based on
                        the job description and your skills
                      </p>
                    </div>
                  )}
                </div>
      ...
      <Dialog open={isAddLetterOpen} onOpenChange={setIsAddLetterOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              {selectedLetter ? "Edit Cover Letter" : "Create Cover Letter"}
            </DialogTitle>
          </DialogHeader>
          <CoverLetterForm
            ...
            onSubmit={async (data) => {
              try {
                ...
                if (!response.ok) {
                  ...
                  throw new Error(
                    errorData.error || "Failed to save cover letter"
                  )
                }
                ...
                toast({
                  title: `Cover Letter ${
                    selectedLetter ? "Updated" : "Created"
                  }`,
                  description: `Your cover letter has been ${
                    selectedLetter ? "updated" : "created"
                  } successfully`
                })
              } catch (error: any) {
                toast({
                  ...
                  description: `Failed to ${
                    selectedLetter ? "update" : "create"
                  } cover letter: ${error.message}`,
                  variant: "destructive"
                })
              }
            }}
        ...
        >
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex justify-end mt-4">
              ...
              <Button onClick={() => handleDownloadPDF("cover-letter-preview")}>
