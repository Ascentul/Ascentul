        ...
        <div className="prose prose-zinc max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-zinc-600">
              By accessing and using Ascentful, you agree to be bound by these Terms of Service
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-zinc-800 mb-4">3. Account Responsibilities</h2>
            <p className="text-zinc-600">
          ...
          <section className="mb-8">
            ...
            <p className="text-zinc-600">
              Ascentful reserves the right to modify or discontinue, temporarily or permanently,
              the service with or without notice. You agree that Ascentful shall not be liable to
          ...
          <section className="mb-8">
            ...
            <p className="text-zinc-600">
              ...
              <a href="mailto:support@ascentful.io" className="text-primary-500 hover:text-primary-700">
