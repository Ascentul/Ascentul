    ...
    <div className="min-h-screen bg-gradient-to-br from-zinc-50 to-zinc-100/50">
      <div className="container mx-auto px-4 py-16 max-w-3xl">
        ...
        <div className="prose prose-zinc max-w-none">
          <p className="text-lg text-zinc-600 mb-6">Last updated: November 2025</p>
          ...
          <section className="mb-8">
            ...
            <p className="text-zinc-600">
              ...
              may include your name, email address, resume data, career goals, and other
          ...
          <section className="mb-8">
            ...
            <p className="text-zinc-600">
              ...
              <a
                href="mailto:privacy@ascentful.io"
