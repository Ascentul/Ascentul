    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="space-x-2">
          <Button variant="outline" onClick={() => router.push('/university/courses')}>
            Back
          </Button>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Input
                type="number"
                value={String(form.enrollments ?? 0)}
                onChange={(e) => setForm({ ...form, enrollments: Number(e.target.value) })}
              />
            </div>
            <div>
              ...
              <Input
                ...
                min={0}
                max={100}
                value={String(form.completion_rate ?? 0)}
