        ...
        messages: [
          {
            role: 'system',
            content:
              'You are a senior career strategist with 15+ years of experience helping professionals advance their careers. Provide detailed, actionable career development plans.',
          },
          {
            role: 'user',
            content: prompt,
    ...
    try {
      careerPath = await convexServer.mutation(
        api.career_paths.createCareerPath,
        {
          ...
          steps: {
            planText: generatedPath,
            inputs: { currentRole, targetRole, skills, experience, timeframe },
          },
          status: 'active',
        },
        token,
