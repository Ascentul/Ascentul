...
export class SessionTrackingService {
   ...
   */
  async trackPageVisit(userId: string, pageName: string): Promise<void> {
    try {
      const sessionId = this.activeSessions.get(userId)
      if (!sessionId) {
   ...
   */
  private async endActiveSession(userId: string): Promise<void> {
   ...
   */
  private async updateUserSessionStats(userId: string): Promise<void> {
    try {
   ...
   */
  async getUserSessionAnalytics(userId: string): Promise<{
