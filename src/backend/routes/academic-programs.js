...
router.get('/', requireUniversityAdmin, async (req, res) => {
    try {
...
router.get('/:id', requireUniversityAdmin, async (req, res) => {
    try {
...
router.post('/', requireUniversityAdmin, async (req, res) => {
    try {
...
router.put('/:id', requireUniversityAdmin, async (req, res) => {
    try {
        const programId = parseInt(req.params.id);
...
router.delete('/:id', requireUniversityAdmin, async (req, res) => {
    try {
        const programId = parseInt(req.params.id);
        const programIndex = academicPrograms.findIndex(p => p.id === programId);
        if (programIndex === -1) {
