    ...
    try {
        ...
        if (contactInfo) {
            ...
            if (window.linkedInProfile) {
                ...
                // Add clickable link
                doc.link(currentX, yPosition - 4, // Slightly above text
                linkWidth, 5, // Height of clickable area
...
export function exportResumeToPDF(elementId, resumeName = "Resume") {
    try {
        ...
        const nameElement = resumeElement.querySelector("h1, h2") ||
 ...
 */
export function exportElementToPDF(elementId, filename = "cover-letter.pdf") {
    try {
        ...
        if (window.linkedInProfile) {
            ...
            if (contactInfo) {
                ...
                if (hasLinkedInText) {
                    ...
                    const updatedHTML = currentHTML.replace(/LinkedIn/g, `<a href="${window.linkedInProfile}" style="color:#0066cc !important; text-decoration:underline !important; font-weight:bold;">LinkedIn</a>`);
            ...
            if (bodyContent) {
                ...
                if (bodyHTML.includes("{{LINKEDIN_URL}}") ||
                    ...
                    updatedHTML = updatedHTML.replace(/\{\{LINKEDIN_URL\}\}/g, `<a href="${window.linkedInProfile}" style="color:#0066cc !important; text-decoration:underline !important; font-weight:bold;">LinkedIn</a>`);
                    // Replace {{LinkedIn}} placeholder
                    updatedHTML = updatedHTML.replace(/\{\{LinkedIn\}\}/g, `<a href="${window.linkedInProfile}" style="color:#0066cc !important; text-decoration:underline !important; font-weight:bold;">LinkedIn</a>`);
