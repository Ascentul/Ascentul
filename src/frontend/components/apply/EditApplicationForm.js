...
import { Loader2, Briefcase, PlusCircle, Trash2 } from 'lucide-react';
...
export function EditApplicationForm({ isOpen, onClose, application, onSuccess }) {
    ...
    const [relatedProcessId, setRelatedProcessId] = useState(null);
    useEffect(() => {
    ...
    const updateApplicationMutation = useMutation({
        mutationFn: async (values) => {
            ...
            const mockAppIndex = mockApps.findIndex((app) => app.id === application.id);
            if (mockAppIndex !== -1) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(Dialog, { open: isOpen, onOpenChange: onClose, children: _jsxs(DialogContent, { className: "sm:max-w-[600px]", children: [_jsxs(DialogHeader, { children: [_jsx(DialogTitle, { children: "Edit Application" }), _jsx(DialogDescription, { children: "Update the details of your job application." })] }), _jsx(Form, { ...form, children: _jsxs("form", { onSubmit: form.handleSubmit(onSubmit), className: "space-y-5", children: [_jsx(FormField, { control: form.control, name: "status", render: ({ field }) => (_jsxs(FormItem, { children: [_jsx(FormLabel, { children: "Application Status*" }), _jsxs(Select, { onValueChange: (value) => {
                                                    ...
                                                    }, defaultValue: field.value, children: [_jsx(FormControl, { children: _jsx(SelectTrigger, { children: _jsx(SelectValue, { placeholder: "Select application status" }) }) }), _jsxs(SelectContent, { children: [_jsx(SelectItem, { value: "In Progress", children: "In Progress" }), _jsx(SelectItem, { value: "Applied", children: "Applied" }), application.status === 'Interviewing' &&
                                                                    _jsx(SelectItem, { value: "Interviewing", children: "Interviewing" }), _jsx(SelectItem, { value: "Offer", children: "Offer" }), _jsx(SelectItem, { value: "Rejected", children: "Rejected" }), _jsx(SelectItem, { value: "Accepted", children: "Accepted" }), _jsx(SelectItem, { value: "Withdrawn", children: "Withdrawn" })] })] }), application.status !== 'Interviewing' && (_jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Note: To set status to \"Interviewing\", create an interview stage in the Interview section first." })), _jsx(FormMessage, {})] })) }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [_jsx(FormField, { control: form.control, name: "company", render: ({ field }) => (_jsxs(FormItem, { children: [_jsx(FormLabel, { children: "Company Name*" }), _jsx(FormControl, { children: _jsx(Input, { placeholder: "Enter company name", ...field }) }), _jsx(FormMessage, {})] })) }), _jsx(FormField, { control: form.control, name: "position", render: ({ field }) => (_jsxs(FormItem, { children: [_jsx(FormLabel, { children: "Position*" }), _jsx(FormControl, { children: _jsx(Input, { placeholder: "Enter job position/title", ...field }) }), _jsx(FormMessage, {})] })) })] }), _jsx(FormField, { control: form.control, name: "location", render: ({ field }) => (_jsxs(FormItem, { children: [_jsx(FormLabel, { children: "Location" }), _jsx(FormControl, { children: _jsx(Input, { placeholder: "Enter job location (e.g., Remote, San Francisco, CA)", ...field }) }), _jsx(FormMessage, {})] })) }), _jsx(FormField, { control: form.control, name: "jobLink", render: ({ field }) => (_jsxs(FormItem, { children: [_jsx(FormLabel, { children: "Job Posting URL" }), _jsx(FormControl, { children: _jsx(Input, { placeholder: "Enter URL to the job posting", ...field }) }), _jsx(FormMessage, {})] })) }), _jsx(FormField, { control: form.control, name: "description", render: ({ field }) => (_jsxs(FormItem, { children: [_jsx(FormLabel, { children: "Job Description" }), _jsx(FormControl, { children: _jsx(Textarea, { placeholder: "Enter job description", className: "min-h-[120px]", ...field }) }), _jsx(FormMessage, {})] })) }), _jsx(FormField, { control: form.control, name: "notes", render: ({ field }) => (_jsxs(FormItem, { children: [_jsx(FormLabel, { children: "Notes" }), _jsx(FormControl, { children: _jsx(Textarea, { placeholder: "Enter any notes about this application", className: "min-h-[80px]", ...field }) }), _jsx(FormMessage, {})] })) }), showInterviewOptions && relatedProcessId && (_jsxs("div", { className: "border rounded-md p-4 space-y-4", children: [_jsxs("h3", { className: "text-base font-medium flex items-center", children: [_jsx(Briefcase, { className: "h-4 w-4 mr-2" }), "Interview Process Options"] }), _jsx("p", { className: "text-sm text-muted-foreground", children: "Since this application is in the interview stage, you can track your interviews and follow-ups." }), _jsxs("div", { className: "flex flex-wrap gap-3", children: [_jsxs(Button, { type: "button", variant: "outline", className: "flex items-center", onClick: () => setShowInterviewStageForm(true), children: [_jsx(PlusCircle, { className: "h-4 w-4 mr-2" }), "Add Interview Stage"] }), _jsxs(Button, { type: "button", variant: "outline", className: "flex items-center", onClick: () => setShowFollowupForm(true), children: [_jsx(PlusCircle, { className: "h-4 w-4 mr-2" }), "Add Follow-up Action"] })] })] })), _jsxs(DialogFooter, { className: "flex justify-between", children: [_jsxs(AlertDialog, { children: [_jsx(AlertDialogTrigger, { asChild: true, children: _jsxs(Button, { type: "button", variant: "outline", className: "gap-1 text-destructive border-destructive hover:bg-destructive/10", children: [_jsx(Trash2, { className: "h-4 w-4" }), "Delete"] }) }), _jsxs(AlertDialogContent, { children: [_jsxs(AlertDialogHeader, { children: [_jsx(AlertDialogTitle, { children: "Are you sure?" }), _jsxs(AlertDialogDescription, { children: ["This will permanently delete the application for ", application.position, " at ", application.company, ". This action cannot be undone."] })] }), _jsxs(AlertDialogFooter, { children: [_jsx(AlertDialogCancel, { children: "Cancel" }), _jsx(AlertDialogAction, { onClick: handleDelete, className: "bg-destructive hover:bg-destructive/90", children: deleteApplicationMutation.isPending ? (_jsxs(_Fragment, { children: [_jsx(Loader2, { className: "mr-2 h-4 w-4 animate-spin" }), "Deleting..."] })) : ('Delete Application') })] })] })] }), _jsxs("div", { className: "flex gap-2", children: [_jsx(Button, { type: "button", variant: "outline", onClick: onClose, children: "Cancel" }), _jsx(Button, { type: "submit", disabled: updateApplicationMutation.isPending, children: updateApplicationMutation.isPending ? (_jsxs(_Fragment, { children: [_jsx(Loader2, { className: "mr-2 h-4 w-4 animate-spin" }), "Saving..."] })) : ('Save Changes') })] })] })] }) })] }) }), showInterviewStageForm && relatedProcessId && (_jsx(InterviewStageForm, { isOpen: showInterviewStageForm, onClose: () => setShowInterviewStageForm(false), processId: relatedProcessId, onSuccess: () => {
                    // Refresh processes data
                    queryClient.invalidateQueries({ queryKey: ['/api/interview/processes'] });
                } })), showFollowupForm && relatedProcessId && (_jsx(FollowupActionForm, { isOpen: showFollowupForm, onClose: () => setShowFollowupForm(false), processId: relatedProcessId, onSuccess: () => {
                    // Refresh processes data
                    queryClient.invalidateQueries({ queryKey: ['/api/interview/processes'] });
                } }))] }));
}
