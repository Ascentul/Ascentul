  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (
        ...
        console.log(
          "Redirecting admin user to admin dashboard. Role:",
          user.role,
          "Type:",
          user.userType
        )
        ...
        console.log(
          "Redirecting staff user to staff dashboard. Role:",
          user.role,
          "Type:",
          user.userType
        )
        ...
        console.log(
          "Redirecting university admin to university dashboard. Role:",
          user.role,
          "Type:",
          user.userType
        )
        ...
        console.log(
          "Redirecting university student to university dashboard. Role:",
          user.role,
          "Type:",
          user.userType
        )
        ...
        console.log(
          "Redirecting regular user to dashboard. Role:",
          user.role,
          "Type:",
          user.userType
        )
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Your account has been created successfully. You've been logged in."
      })
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-center">CareerTracker.io</DialogTitle>
