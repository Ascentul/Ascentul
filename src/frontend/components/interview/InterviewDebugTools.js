...
export function InterviewDebugTools() {
    ...
    const clearAllInterviewData = () => {
        ...
        try {
            ...
            const interviewKeys = keys.filter(key => key.startsWith('mockStages_') ||
    ...
    return (_jsxs(Card, { className: "my-4", children: [_jsx(CardHeader, { className: "pb-2", children: _jsx(CardTitle, { className: "text-lg", children: "Debug Tools" }) }), _jsx(CardContent, { children: _jsx("div", { className: "flex flex-col gap-4", children: _jsxs("div", { children: [_jsx("p", { className: "text-sm text-muted-foreground mb-2", children: "Use this button to completely clear all interview data. This will remove all interview stages, followups, and other related data." }), _jsx(Button, { variant: "destructive", onClick: clearAllInterviewData, disabled: isClearing, className: "w-full", children: isClearing ? (_jsxs(_Fragment, { children: [_jsx(Loader2, { className: "mr-2 h-4 w-4 animate-spin" }), "Clearing Data..."] })) : (_jsxs(_Fragment, { children: [_jsx(Trash, { className: "mr-2 h-4 w-4" }), "Clear All Interview Data"] })) })] }) }) })] }));
}
