...
import { Square, Circle, Triangle, Type, Grid, Layers, Move, Trash, Copy, AlignLeft, AlignCenter, AlignRight, AlignJustify, Bold, Italic, Underline } from "lucide-react";
...
export default function DesignEditor({ initialDesign, onSave }) {
    ...
    const drawGrid = async (canvas) => {
        // Remove any existing grid
        const existingGrid = canvas.getObjects().filter((o) => o.isGrid);
    ...
    const toggleGrid = () => {
        ...
        if (newGridState) {
            ...
            const existingGrid = fabricCanvas.getObjects().filter((o) => o.isGrid);
            existingGrid.forEach((grid) => fabricCanvas.remove(grid));
    ...
    const handleObjectMoving = (e) => {
        ...
        const snaps = {
            left: { distance: SNAP_THRESHOLD, position: null },
            centerX: { distance: SNAP_THRESHOLD, position: null },
            right: { distance: SNAP_THRESHOLD, position: null },
            top: { distance: SNAP_THRESHOLD, position: null },
            centerY: { distance: SNAP_THRESHOLD, position: null },
            bottom: { distance: SNAP_THRESHOLD, position: null }
        };
        ...
        if (snapToObjectsEnabled) {
            const otherObjects = canvas.getObjects().filter((o) => o !== obj && !o.isGrid && !o.isGuideLine && o.selectable !== false);
    ...
    const checkAndUpdateSnap = (snapObj, objPosition, targetPosition, orientation, length) => {
    ...
    const createGuideLine = async (x1, y1, x2, y2, type) => {
        // Get fabric instance
        const fabric = await getFabric();
    ...
    const clearGuides = async () => {
        ...
        try {
            ...
            const existingGuides = canvasObjects.filter((o) => o && o.isGuideLine);
    ...
    const loadDesign = async (canvas, jsonData) => {
        try {
    ...
    return (_jsxs("div", { className: "flex flex-col w-full h-full overflow-hidden", children: [_jsxs("div", { className: "bg-white border-b p-2 flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center space-x-2", children: [_jsx("h2", { className: "text-lg font-medium", children: "Design Editor" }), _jsx(Button, { variant: "outline", size: "sm", onClick: saveDesign, children: "Save" })] }), _jsxs("div", { className: "flex items-center space-x-2", children: [_jsx(TooltipProvider, { children: _jsxs(Tooltip, { children: [_jsx(TooltipTrigger, { asChild: true, children: _jsxs(Button, { variant: gridEnabled ? "secondary" : "outline", size: "sm", onClick: toggleGrid, children: [_jsx(Grid, { className: "h-4 w-4 mr-1" }), "Grid"] }) }), _jsx(TooltipContent, { children: "Toggle grid visibility" })] }) }), _jsx(TooltipProvider, { children: _jsxs(Tooltip, { children: [_jsx(TooltipTrigger, { asChild: true, children: _jsxs(Button, { variant: snapToGridEnabled ? "secondary" : "outline", size: "sm", onClick: () => setSnapToGridEnabled(!snapToGridEnabled), children: [_jsx(Layers, { className: "h-4 w-4 mr-1" }), "Snap to Grid"] }) }), _jsx(TooltipContent, { children: "Toggle snap to grid" })] }) }), _jsx(TooltipProvider, { children: _jsxs(Tooltip, { children: [_jsx(TooltipTrigger, { asChild: true, children: _jsxs(Button, { variant: snapToObjectsEnabled ? "secondary" : "outline", size: "sm", onClick: () => setSnapToObjectsEnabled(!snapToObjectsEnabled), children: [_jsx(Move, { className: "h-4 w-4 mr-1" }), "Smart Guides"] }) }), _jsx(TooltipContent, { children: "Toggle snap to objects" })] }) })] })] }), _jsxs("div", { className: "flex-1 flex", children: [_jsxs("div", { className: "w-12 bg-white border-r flex flex-col items-center py-2 space-y-2", children: [_jsx(TooltipProvider, { children: _jsxs(Tooltip, { children: [_jsx(TooltipTrigger, { asChild: true, children: _jsx(Button, { variant: "ghost", size: "icon", onClick: addRectangle, children: _jsx(Square, { className: "h-5 w-5" }) }) }), _jsx(TooltipContent, { side: "right", children: "Add Rectangle" })] }) }), _jsx(TooltipProvider, { children: _jsxs(Tooltip, { children: [_jsx(TooltipTrigger, { asChild: true, children: _jsx(Button, { variant: "ghost", size: "icon", onClick: addCircle, children: _jsx(Circle, { className: "h-5 w-5" }) }) }), _jsx(TooltipContent, { side: "right", children: "Add Circle" })] }) }), _jsx(TooltipProvider, { children: _jsxs(Tooltip, { children: [_jsx(TooltipTrigger, { asChild: true, children: _jsx(Button, { variant: "ghost", size: "icon", onClick: addTriangle, children: _jsx(Triangle, { className: "h-5 w-5" }) }) }), _jsx(TooltipContent, { side: "right", children: "Add Triangle" })] }) }), _jsx(TooltipProvider, { children: _jsxs(Tooltip, { children: [_jsx(TooltipTrigger, { asChild: true, children: _jsx(Button, { variant: "ghost", size: "icon", onClick: addText, children: _jsx(Type, { className: "h-5 w-5" }) }) }), _jsx(TooltipContent, { side: "right", children: "Add Text" })] }) }), _jsx("div", { className: "border-t my-2 w-8" }), _jsx(TooltipProvider, { children: _jsxs(Tooltip, { children: [_jsx(TooltipTrigger, { asChild: true, children: _jsx(Button, { variant: "ghost", size: "icon", onClick: deleteObject, disabled: !activeObject, children: _jsx(Trash, { className: "h-5 w-5" }) }) }), _jsx(TooltipContent, { side: "right", children: "Delete" })] }) }), _jsx(TooltipProvider, { children: _jsxs(Tooltip, { children: [_jsx(TooltipTrigger, { asChild: true, children: _jsx(Button, { variant: "ghost", size: "icon", onClick: cloneObject, disabled: !activeObject, children: _jsx(Copy, { className: "h-5 w-5" }) }) }), _jsx(TooltipContent, { side: "right", children: "Duplicate" })] }) })] }), _jsx("div", { className: "flex-1 bg-gray-100 overflow-auto p-4 flex items-center justify-center", children: _jsxs("div", { className: "relative bg-white shadow-lg", children: [_jsx("canvas", { ref: canvasRef }), !isCanvasReady && (_jsx("div", { className: "absolute inset-0 flex items-center justify-center bg-white", children: _jsx("div", { className: "animate-spin h-10 w-10 border-4 border-primary border-t-transparent rounded-full" }) }))] }) }), activeObject && (_jsxs("div", { className: "w-64 bg-white border-l p-4 overflow-y-auto", children: [_jsx("h3", { className: "text-sm font-medium mb-4", children: "Properties" }), _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { children: [_jsx("h4", { className: "text-xs font-medium mb-2", children: "Position" }), _jsxs("div", { className: "grid grid-cols-2 gap-2", children: [_jsxs("div", { children: [_jsx(Label, { htmlFor: "posX", className: "text-xs", children: "X" }), _jsx(Input, { id: "posX", type: "number", value: Math.round(activeObject.left), onChange: (e) => {
                                                                    activeObject.set({ left: parseInt(e.target.value) });
                                                                    fabricCanvas.renderAll();
                                                                }, className: "h-8" })] }), _jsxs("div", { children: [_jsx(Label, { htmlFor: "posY", className: "text-xs", children: "Y" }), _jsx(Input, { id: "posY", type: "number", value: Math.round(activeObject.top), onChange: (e) => {
                                                                    activeObject.set({ top: parseInt(e.target.value) });
                                                                    fabricCanvas.renderAll();
                                                                }, className: "h-8" })] })] }), _jsxs("div", { className: "flex justify-between mt-2", children: [_jsx(Button, { variant: "outline", size: "sm", className: "h-7 text-xs", onClick: centerHorizontally, children: "Center H" }), _jsx(Button, { variant: "outline", size: "sm", className: "h-7 text-xs", onClick: centerVertically, children: "Center V" })] })] }), _jsxs("div", { children: [_jsx("h4", { className: "text-xs font-medium mb-2", children: "Size" }), _jsxs("div", { className: "grid grid-cols-2 gap-2", children: [_jsxs("div", { children: [_jsx(Label, { htmlFor: "width", className: "text-xs", children: "Width" }), _jsx(Input, { id: "width", type: "number", value: Math.round(activeObject.getScaledWidth()), onChange: (e) => {
                                                                    activeObject.set({ width: parseInt(e.target.value) / activeObject.scaleX });
                                                                    fabricCanvas.renderAll();
                                                                }, className: "h-8" })] }), _jsxs("div", { children: [_jsx(Label, { htmlFor: "height", className: "text-xs", children: "Height" }), _jsx(Input, { id: "height", type: "number", value: Math.round(activeObject.getScaledHeight()), onChange: (e) => {
                                                                    activeObject.set({ height: parseInt(e.target.value) / activeObject.scaleY });
                                                                    fabricCanvas.renderAll();
                                                                }, className: "h-8" })] })] })] }), _jsxs("div", { children: [_jsx("h4", { className: "text-xs font-medium mb-2", children: "Style" }), _jsxs("div", { className: "mb-2", children: [_jsx(Label, { htmlFor: "fill", className: "text-xs", children: "Fill Color" }), _jsxs("div", { className: "flex items-center mt-1", children: [_jsx("input", { type: "color", id: "fill", value: activeObject.fill || '#000000', onChange: (e) => {
                                                                    activeObject.set({ fill: e.target.value });
                                                                    fabricCanvas.renderAll();
                                                                }, className: "w-8 h-8 mr-2" }), _jsx(Input, { value: activeObject.fill || '#000000', onChange: (e) => {
                                                                    activeObject.set({ fill: e.target.value });
                                                                    fabricCanvas.renderAll();
                                                                }, className: "h-8 font-mono text-sm" })] })] }), _jsxs("div", { className: "mb-2", children: [_jsxs(Label, { htmlFor: "opacity", className: "text-xs flex justify-between", children: [_jsx("span", { children: "Opacity" }), _jsxs("span", { children: [Math.round(activeObject.opacity * 100), "%"] })] }), _jsx(Slider, { id: "opacity", min: 0, max: 1, step: 0.01, value: [activeObject.opacity], onValueChange: (value) => {
                                                            activeObject.set({ opacity: value[0] });
                                                            fabricCanvas.renderAll();
                                                        }, className: "mt-1.5" })] })] }), activeObject.type === 'textbox' && (_jsxs("div", { children: [_jsx("h4", { className: "text-xs font-medium mb-2", children: "Text" }), _jsxs("div", { className: "mb-2", children: [_jsx(Label, { htmlFor: "text", className: "text-xs", children: "Content" }), _jsx(Input, { id: "text", value: activeObject.text, onChange: (e) => {
                                                            activeObject.set({ text: e.target.value });
                                                            fabricCanvas.renderAll();
                                                        }, className: "h-8 mt-1" })] }), _jsxs("div", { className: "flex items-center space-x-1 mb-2", children: [_jsx(Button, { variant: activeObject.fontWeight === 'bold' ? 'secondary' : 'outline', size: "sm", className: "h-7 w-7 p-0", onClick: () => {
                                                            activeObject.set({ fontWeight: activeObject.fontWeight === 'bold' ? 'normal' : 'bold' });
                                                            fabricCanvas.renderAll();
                                                        }, children: _jsx(Bold, { className: "h-4 w-4" }) }), _jsx(Button, { variant: activeObject.fontStyle === 'italic' ? 'secondary' : 'outline', size: "sm", className: "h-7 w-7 p-0", onClick: () => {
                                                            activeObject.set({ fontStyle: activeObject.fontStyle === 'italic' ? 'normal' : 'italic' });
                                                            fabricCanvas.renderAll();
                                                        }, children: _jsx(Italic, { className: "h-4 w-4" }) }), _jsx(Button, { variant: activeObject.underline ? 'secondary' : 'outline', size: "sm", className: "h-7 w-7 p-0", onClick: () => {
                                                            activeObject.set({ underline: !activeObject.underline });
                                                            fabricCanvas.renderAll();
                                                        }, children: _jsx(Underline, { className: "h-4 w-4" }) })] }), _jsxs("div", { className: "flex items-center space-x-1 mb-2", children: [_jsx(Button, { variant: activeObject.textAlign === 'left' ? 'secondary' : 'outline', size: "sm", className: "h-7 w-7 p-0", onClick: () => {
                                                            activeObject.set({ textAlign: 'left' });
                                                            fabricCanvas.renderAll();
                                                        }, children: _jsx(AlignLeft, { className: "h-4 w-4" }) }), _jsx(Button, { variant: activeObject.textAlign === 'center' ? 'secondary' : 'outline', size: "sm", className: "h-7 w-7 p-0", onClick: () => {
                                                            activeObject.set({ textAlign: 'center' });
                                                            fabricCanvas.renderAll();
                                                        }, children: _jsx(AlignCenter, { className: "h-4 w-4" }) }), _jsx(Button, { variant: activeObject.textAlign === 'right' ? 'secondary' : 'outline', size: "sm", className: "h-7 w-7 p-0", onClick: () => {
                                                            activeObject.set({ textAlign: 'right' });
                                                            fabricCanvas.renderAll();
                                                        }, children: _jsx(AlignRight, { className: "h-4 w-4" }) }), _jsx(Button, { variant: activeObject.textAlign === 'justify' ? 'secondary' : 'outline', size: "sm", className: "h-7 w-7 p-0", onClick: () => {
                                                            activeObject.set({ textAlign: 'justify' });
                                                            fabricCanvas.renderAll();
                                                        }, children: _jsx(AlignJustify, { className: "h-4 w-4" }) })] }), _jsxs("div", { className: "mb-2", children: [_jsx(Label, { htmlFor: "fontSize", className: "text-xs", children: "Font Size" }), _jsx(Input, { id: "fontSize", type: "number", value: activeObject.fontSize, onChange: (e) => {
