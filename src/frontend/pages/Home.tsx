          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="text-left">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                From resume building to interview prep, goal tracking to AI
                coaching, CareerTracker.io gives you the tools to take control
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Our comprehensive suite of tools helps you plan, prepare, and
              progress at every stage of your career.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <p className="text-muted-foreground mb-4">
                Create customized resumes and cover letters tailored to specific
                job applications with AI assistance.
              </p>
              <button
                onClick={() => setShowSignupDialog(true)}
            ...
            >
              ...
              <p className="text-muted-foreground mb-4">
                Set, track, and achieve your professional goals with intelligent
            ...
            >
              ...
              <p className="text-muted-foreground mb-4">
                Specialized tools for university students including study plans,
                learning modules, and academic tracking.
              </p>
              <button
                onClick={() => setShowSignupDialog(true)}
                className="text-primary font-medium flex items-center hover:underline bg-transparent border-none p-0 cursor-pointer"
            ...
            >
              ...
              <p className="text-muted-foreground mb-4">
                Practice interviews with AI-generated questions specific to your
                industry and role, with feedback and improvement tips.
              </p>
              <button
                onClick={() => setShowSignupDialog(true)}
                className="text-primary font-medium flex items-center hover:underline bg-transparent border-none p-0 cursor-pointer"
            ...
            >
              ...
              <p className="text-muted-foreground mb-4">
                Earn XP, unlock achievements, and track your progress as you
                develop your career skills and hit milestones.
              </p>
              <button
                onClick={() => setShowSignupDialog(true)}
                className="text-primary font-medium flex items-center hover:underline bg-transparent border-none p-0 cursor-pointer"
            ...
            >
              ...
              <p className="text-muted-foreground mb-4">
                ...
                that adapts to your unique situation.
              </p>
              <button
                onClick={() => setShowSignupDialog(true)}
                className="text-primary font-medium flex items-center hover:underline bg-transparent border-none p-0 cursor-pointer"
      ...
      <section className="py-16 bg-gradient-to-b from-primary/5 to-background">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              CareerTracker.io has helped thousands of professionals and
              students worldwide.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              ...
              <p className="text-muted-foreground mb-4">
                "CareerTracker.io helped me land my dream job. The AI interview
                coach was incredibly useful in preparing me for tough
                questions."
              </p>
            ...
            >
              ...
              <p className="text-muted-foreground mb-4">
                "The goal tracking feature helps me stay focused and motivated.
                I've accomplished more in 6 months than I did in the past 2
                years."
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary font-semibold mr-3">
            ...
            >
              ...
              <p className="text-muted-foreground mb-4">
                "As a university student, the University Edition has been
                invaluable for planning my courses and mapping my career path
                after graduation."
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary font-semibold mr-3">
            ...
            <Accordion type="single" collapsible className="space-y-4">
              ...
              >
                <AccordionTrigger className="text-left font-medium py-4">
                  What makes CareerTracker.io different from other career
                  platforms?
                </AccordionTrigger>
                <AccordionContent className="pb-4">
                  CareerTracker.io combines powerful AI technology with
                  gamification elements to make career development engaging and
                  effective. Unlike other platforms, we offer a comprehensive
                  ecosystem of tools specifically designed to address every
                  aspect of your career journey, from resume building to
                  interview preparation, all in one integrated platform.
                </AccordionContent>
              </AccordionItem>
              ...
              >
                ...
                <AccordionContent className="pb-4">
                  ...
                  resume builder, work history tracking, and limited goal
                  setting. Pro subscribers get unlimited access to all features
                  including AI interview coaching, advanced goal tracking,
                  personalized career recommendations, priority support, and no
                  usage limits on document generation.
                </AccordionContent>
              </AccordionItem>
              ...
              >
                ...
                <AccordionContent className="pb-4">
                  ...
                  your data is encrypted both in transit and at rest. We never
                  share your personal information with third parties without
                  your explicit consent. You can export or delete your data at
              ...
              >
                ...
                <AccordionContent className="pb-4">
                  The University Edition is designed for educational
                  institutions to provide career development tools to their
                  students. It includes all Pro features plus specialized tools
                  for academic planning, study modules, and administrative
                  dashboards for university staff. Students get access through
                  their institution's license and can use it throughout their
                  studies.
                </AccordionContent>
              </AccordionItem>
              ...
              >
                ...
                <AccordionContent className="pb-4">
                  ...
                  from your account settings. When you cancel, you'll continue
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Join thousands of professionals and students who are taking
              control of their future with CareerTracker.io.
            </p>
            ...
            <p className="mt-8 text-sm italic text-muted-foreground">
              Take the first step toward a better career today. Free accounts
