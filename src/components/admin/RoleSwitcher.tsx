...
import { Briefcase, Building2, ChevronDown, Eye, GraduationCap, User, Users } from 'lucide-react';
...
export function RoleSwitcher() {
  ...
  const { impersonation, startImpersonating, stopImpersonating, canImpersonate } =
    useImpersonation();
      ...
      <DropdownMenuContent align="end" className="w-64">
        ...
        <DropdownMenuSub>
          ...
          <DropdownMenuSubContent>
            ...
            <DropdownMenuRadioGroup
              value={
                impersonation.role === 'individual' ? impersonation.plan || 'free' : selectedPlan
              }
              onValueChange={(value) => {
            ...
            {universities && universities.length > 0 ? (
              universities.slice(0, 10).map((uni) => (
                <DropdownMenuItem
                  ...
                  className={
                    impersonation.role === 'university_admin' &&
                    impersonation.universityId === uni._id
                      ? 'bg-neutral-100'
                      : ''
                  }
                >
