/**
 * Advisor Dashboard Components
 *
 * Action-oriented dashboard components for the redesigned advisor experience.
 * These components answer three key questions:
 * 1. Who needs my attention right now? (NeedsAttentionStrip)
 * 2. Who might quietly be slipping through the cracks? (RiskOverviewPanel)
