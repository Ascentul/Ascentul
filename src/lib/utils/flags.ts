 ...
 */
export const isAgentEnabled = (flags?: any): boolean => {
 ...
 */
export const isProactiveEnabled = (flags?: any): boolean => {
 ...
 */
export const isEmailNudgesEnabled = (flags?: any): boolean => {
 ...
 */
export const isPushNudgesEnabled = (flags?: any): boolean => {
 ...
 */
export const isResumeAnalysisEnabled = (flags?: any): boolean => {
 ...
 */
export const isCareerPathEnabled = (flags?: any): boolean => {
 ...
 */
export const isJobMatchingEnabled = (flags?: any): boolean => {
 ...
 */
export const isFeatureEnabled = (flags: any, path: string): boolean => {
