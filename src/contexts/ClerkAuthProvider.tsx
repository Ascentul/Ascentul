...
export function ClerkAuthProvider({ children }: { children: React.ReactNode }) {
  ...
  // REMOVED: Defensive role sync (Convex is now source of truth)
  // Previously: synced role FROM Clerk TO Convex when mismatch detected
  // Now: Convex role is canonical, Clerk metadata is mirror only
